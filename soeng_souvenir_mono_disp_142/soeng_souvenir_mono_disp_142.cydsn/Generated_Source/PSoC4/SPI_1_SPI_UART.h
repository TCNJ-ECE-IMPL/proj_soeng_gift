...
#define SPI_1_SPI_OVS_FACTOR             (6u)
#define SPI_1_SPI_MEDIAN_FILTER_ENABLE   (0u)
#define SPI_1_SPI_LATE_MISO_SAMPLE_ENABLE (0u)
#define SPI_1_SPI_RX_DATA_BITS_NUM       (10u)
#define SPI_1_SPI_TX_DATA_BITS_NUM       (10u)
...
/* Common APIs TX direction */
    ...
    void   SPI_1_SpiUartPutArray(const uint16 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define SPI_1_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    SPI_1_rxBufferInternal[(idx)] = ((uint16) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define SPI_1_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        SPI_1_txBufferInternal[(idx)] = ((uint16) (txDataByte)); \
                    }while(0)
